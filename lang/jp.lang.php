...
// ボタンに使う
    ...
    $lang->cmd_view_info = '情報';

    $lang->new_rss_list = '新着RSS';
    $lang->my_rss_list = 'マイRSS';


    $lang->popular_tag_period = 'タグ表示期間';
    $lang->about_popular_tag_period = '人気タグを表示する際、タグの対象期間範囲を定めます。 (単位：日、基本：30日)';
